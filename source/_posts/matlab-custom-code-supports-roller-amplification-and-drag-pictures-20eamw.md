...
updated: '2023-11-12 18:42:55'
excerpt: >-
  Matlab
  虽然自带的imshow也支持鼠标滚轮放大缩小，鼠标左键拖动放大的图片调整视野，但是一旦把menubar给关了，就丢失了zoom和pan的功能，最离谱的是——zoom和pan还只能开一个，开了zoom就不能开pan。所以打算自己撸一个同时支持鼠标滚轮放大图片和左键拖动图片的功能。
tags:
  - Matlab
categories:
  - 技术博客
